...
/**
 * Standard Top App Bar for DNotes.
 *
 * @param title The text to display in the top bar.
 * @param showBackButton Whether to display the left-aligned back arrow.
 * @param onBackClick Callback triggered when the back button is pressed.
 * @param modifier Modifier for styling or layout.
 * @param actions Optional slot for trailing action icons (e.g., Delete, Search).
 */
